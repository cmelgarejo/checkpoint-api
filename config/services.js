  ...
  ally: {
    ...
    */
    facebook: {
      ...
      redirectUri: `${Env.get('APP_URL')}/v2/auth/social/authenticated/facebook`
    },
    ...
    */
    google: {
      ...
      redirectUri: `${Env.get('APP_URL')}/v2/auth/social/authenticated/google`
    },
    ...
    */
    github: {
      ...
      redirectUri: `${Env.get('APP_URL')}/v2/auth/social/authenticated/github`
    },
    ...
    instagram: {
      ...
      redirectUri: `${Env.get('APP_URL')}/v2/auth/social/authenticated/instagram`
    },
    ...
    foursquare: {
      ...
      redirectUri: `${Env.get('APP_URL')}/v2/auth/social/authenticated/foursquare`
    }
  }
}
